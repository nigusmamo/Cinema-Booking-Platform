  ...
  <div class="pb-16">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
      <div>
        ...
        <p class="text-[12px] text-white/30">{{ filteredStars.length }} total stars</p>
      </div>
    ...
    <!-- Empty State -->
    <div v-else-if="filteredStars.length === 0" class="py-20 flex flex-col items-center justify-center gap-3">
    ...
    <!-- Pagination -->
    <AdminPagination v-model="currentPage" :total-items="filteredStars.length" :page-size="pageSize" />
...
const filteredStars = computed(() => {
  ...
  return stars.value.filter((s: any) => s.name.toLowerCase().includes(query))
})
